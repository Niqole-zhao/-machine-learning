...
y_train_savepath = './fashion_image_label/fashion_y_train.npy'
...
model.comiple(optimizer="adam",
             loss=tf.keras.losses.SparseCategoricalCrossentropy(from_logits=False),
             metrics=["spares_categorical_accuracy"])
model.fit(x_train, batch_size=32, epoch_size=32, epochs=5, validation_data=(x_test,y_test), validation_freq=1)
model.summary()